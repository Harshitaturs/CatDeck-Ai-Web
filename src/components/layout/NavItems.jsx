...
const NavItems = () => {
    ...
    const links = [
        { name: "Home", path: "/" },
        { name: "Work", path: "https://harshit-portfolio-mu.vercel.app/", external: true },
    ];
        ...
        <div className="relative flex items-center bg-[#1e293b]/90 backdrop-blur-lg rounded-full p-1.5 shadow-2xl border border-white/10 w-fit mx-auto transition-all duration-300 scale-90 md:scale-100">
                    ...
                    <div className="absolute left-0 top-full mt-3 w-64 md:w-80 bg-[#1e293b] border border-white/10 rounded-2xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-2 group-hover:translate-y-0 transition-all duration-300 z-100 p-5 overflow-hidden">
                        ...
                        <div className="space-y-3 text-gray-300 text-[11px] md:text-xs leading-relaxed normal-case tracking-normal mb-4">
                            ...
                            <p>
                                ...
                                <a href="https://www.linkedin.com/in/withharshit/" target="_blank"><u>Harshit</u></a>
                                and
                                <a href="https://www.linkedin.com/in/chirag-in/" target="_blank"><u>Chirag</u></a>,
                                focused on simplifying web development workflows while showcasing our evolving technical skills and portfolio.
                            </p>
                        </div>
            ...
            <div className="relative group">
                ...
                <div className="absolute right-0 top-full mt-3 w-32 md:w-40 bg-[#1e293b] border border-white/10 rounded-2xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-2 group-hover:translate-y-0 transition-all duration-300 z-100 overflow-hidden">
                    <a href="https://www.linkedin.com/in/withharshit/" target="_blank" className="block px-4 py-3 text-[10px] md:text-xs hover:bg-accent hover:text-[#0f172a] text-gray-300 font-bold transition-colors border-b border-white/5">LinkedIn</a>
                    <a href="https://github.com/Harshitaturs" target="_blank" className="block px-4 py-3 text-[10px] md:text-xs hover:bg-accent hover:text-[#0f172a] text-gray-300 font-bold transition-colors border-b border-white/5">GitHub</a>
                    <a
                        href="https://mail.google.com/mail/?view=cm&fs=1&to=harshitknows@gmail.com&su="
                        target="_blank"
                        rel="noopener noreferrer"
