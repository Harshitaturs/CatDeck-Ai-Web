        ...
        >
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    type="submit"
                    disabled={isTyping}
                    className={`h-9 w-9 flex items-center justify-center rounded-xl transition-all duration-300 ${isTyping
                ...
                >
                    {isTyping ? (
                        <div className="w-3 h-3 bg-amber-400 rounded-sm animate-spin" style={{ animationDuration: '3s' }}></div>
                    ) : (
                        <span className="material-symbols-rounded text-[20px] font-bold">arrow_upward</span>
                    )}
                </button>
            </div>
        </form>
