...
const ChatMessage = ({ chat }) => {
    ...
    return (
        <div className={`flex w-full px-2 md:px-4 py-2 ${isBot ? "justify-start" : "justify-end"}`}>
            <div className={`flex gap-3 max-w-[85%] md:max-w-[70%] ${isBot ? "flex-row" : "flex-row-reverse"}`}>
                ...
                <div
                    className={`px-4 py-2.5 text-sm md:text-base shadow-lg ${chat.isError
